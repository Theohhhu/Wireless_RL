...
class hvenv(object):
    ...
    def __init__(self,path,v_state_num, v_num,hv_env_num):
        ...
        # 生成 一个batch的变相器状态v
        self.v = np.ones((hv_env_num,v_num))
    ...
    def step(self,delta_v):
        ...
        return obs,obs_next,reward,self.count == 0
    ...
    def random_delta_v(self):
        return np.random.randint(self.v_state_num, size = self.hv_env_num) * self.v_state_num - 1
