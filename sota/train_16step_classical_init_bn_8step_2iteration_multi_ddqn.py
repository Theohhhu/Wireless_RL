import numpy as np
import torch
from myenv.hvenv_16step_classical_init_nstep_niteration   import hvenv
...
SAVE_PATH = '../sota/weight/train_16step_classical_init_bn_8step_2iteration_multi_large_ddqn_best_model.pth'
...
def main():
    ...
    while True:
        ...
        if i % 100 == 0:
            obs_val, reward_val, reward_record = eval(rlnnet, envs_val, obs_val, epsilon, cuda0, reward_val,
                                                      reward_record)
