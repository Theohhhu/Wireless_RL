...
def main():
    ...
    # rlnnet = torch.load('../weight/16step_large_ddqn_classical_init_-4learning_rate'+str(step_num)+'step_'+str(iteration_num)+'iteration_best_model.pth')
    ...
    while True:
        ...
        if i % SYC_NUM == 0:
            ...
            torch.save(rlnnet, '../weight/16step_large_ddqn_classical_init_-3learning_rate'+str(step_num)+'step_'+str(iteration_num)+'iteration_best_model.pth')
