...
from rlnnet.rl_deep_bn_dqn import DQN
...
def main():
    ...
    while True:
        ...
        if i % SYC_NUM == 0:
            ...
            torch.save(rlnnet, '../weight/deep_ddqn_classical_init_-4learning_rate'+str(step_num)+'step_'+str(iteration_num)+'iteration_best_model.pth')
